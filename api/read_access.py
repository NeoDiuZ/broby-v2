...
ROUTES = {
    ...
    **{path: ALL for path in (
        ...
        '/api/operations/status', '/api/operations/health', '/api/consultations/{id}/pdf', '/api/consultations/{id}/text',
        ...
        '/api/clinical-reconciliation/{id}', '/api/clinical-reconciliation/{id}/media/{record_id}',
        '/api/clinical-reconciliation/patients/{patient_id}/history', '/api/clinical-reconciliation/patients/{patient_id}/media/{record_id}',
