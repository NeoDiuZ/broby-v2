...
def restore(archive,destination):
    ...
    try:
        ...
        with db.connection(True) as c:
            ...
            for term in m.get('ontology',[]):c.execute('INSERT OR REPLACE INTO ontology VALUES(?,?,?,?,?)',(term['code'],term['name'],term['value_type'],term['unit'],term['category']))
    ...
    finally:db.DB,db.DATA=original_db,original_data
