...
export type Measurement={id:string;concept:string;name:string;value:number|string|boolean;value_type:string;unit:string;ref_low:number|null;ref_high:number|null;flag:'high'|'low'|null;source:Receipt|null};
