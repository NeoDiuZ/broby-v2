...
import {cacheSnapshot,cachedSnapshot,deviceScopeAllowed} from './device';
...
export function Workspace({children}:{children:React.ReactNode}){
 ...
 return <C.Provider value={{snapshot,records:snapshot?.records||[],error,loading,offline,pending,cachedAt,refresh,act,switchIdentity,notify,toast}}>{children}</C.Provider>
}
