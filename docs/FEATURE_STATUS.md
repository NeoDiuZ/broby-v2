...
| 8 | One action layer for UI and AI | **Implemented.** Shared authorized, versioned, idempotent audited mutations; AI proposals require confirmation. Ten routine actions have strict proposal schemas, reference checks and labelled reviews, including eight newly advertised operations. The catalogue covers 59 of 89 shared actions; the remaining contracts and broader intent evaluation are unfinished. See ASSISTANT_OPERATIONS.md. |
